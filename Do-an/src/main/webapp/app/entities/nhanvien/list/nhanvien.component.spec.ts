...
import { sampleWithRequiredData } from '../nhanvien.test-samples';
...
describe('Nhanvien Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'nhanvien', component: NhanvienComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to nhanvienService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getNhanvienIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getNhanvienIdentifier).toHaveBeenCalledWith(entity);
