...
import { sampleWithRequiredData } from '../chucvu.test-samples';
...
describe('Chucvu Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'chucvu', component: ChucvuComponent }]), HttpClientTestingModule, ChucvuComponent],
      providers: [
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.chucvus?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to chucvuService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getChucvuIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getChucvuIdentifier).toHaveBeenCalledWith(entity);
