...
import { sampleWithRequiredData } from '../phongban.test-samples';
...
describe('Phongban Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'phongban', component: PhongbanComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.phongbans?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to phongbanService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPhongbanIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPhongbanIdentifier).toHaveBeenCalledWith(entity);
